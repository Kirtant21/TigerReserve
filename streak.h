...
class Streak{
 ...
 private:
  ...
  // ***************************************************
  Tiger* recursiveTigerInsert(Tiger* pTiger, int tigerId, const Tiger& nTiger);
  void  destructRecursively(Tiger* tiger);
  Tiger* rightRotation(Tiger* tiger);
  Tiger* leftRotation(Tiger* tiger);
  Tiger* removeRecursively(Tiger* root, int id);
  Tiger* findMinRecursively(Tiger* tiger);
  void listTigersRecursively(Tiger* tiger) const;
  void removeDeadRecursively(Tiger* tiger);
  void removeRoot();
  int countCubRecursively(const Tiger* tiger, int count = 0) const;
};
#endif
